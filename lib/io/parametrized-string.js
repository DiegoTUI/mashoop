 ...
 */
exports.ParametrizedString = function(baseString, parameters) {
	// self-reference
	var self = this;
...
function testUndefinedParamString (callback) {
	var paramString = new exports.ParametrizedString ();
...
function testExactMatch (callback) {
	...
	var paramString = new exports.ParametrizedString (testBaseString, params);

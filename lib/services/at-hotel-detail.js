...
exports.ATHotelDetail = function(queryParameters, descriptionMap, tag, forceCall) {
	...
	function makeRequest(callback) {
		...
		var parametrizedRequest = new ParametrizedString(atlas.hotelDetailRequest, queryParameters);
...
function testHotelDetailRequest (callback) {
	function atlasCallback(error, result) {
		...
		testing.assertEquals(result.Code, parameters.hotel, 'Wrong hotel returned', callback);
...
function testHotelDetailRequestErrors (callback) {
	...
	var parameters = {
		hotel: 'invalidCode',	//UNEXISTING CODE!!!
		debug: true
	};

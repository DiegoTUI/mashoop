 ...
 */
exports.ATTicketAvail = function(queryParameters, descriptionMap, tag) {
	// self-reference
	var self = this;
	//debug mode
	...
	function getMemcachedKey(parameters) {
		return 'ticket#' + parameters.destination + '#' + parameters.from + '#' + parameters.to;
	}
	...
	function initParameters() {
		serviceParameters = {
			Destination_code: queryParameters.destination,
			DateFrom_date: queryParameters.from,
			DateTo_date: queryParameters.to,
		}

...
/**
 * The HotelList request in Atlas.
...
exports.ATHotelList = function(queryParameters, descriptionMap, tag, forceCall) {
	...
	// default request
	var defaultRequest = atlasDefaults.hotelListRequest;
	...
	function getMemcachedKey(parameters) {
		return 'athotellist#' + parameters.destination + '#' + parameters.language;
	}
	...
	function makeRequest(callback) {
		...
		var parametrizedRequest = new ParametrizedString(atlas.hotelListRequest, queryParameters);
			...
			errorReader.readObjects(function(errorParsing, parsedErrors){
				if ('ErrorList' in parsedErrors) {	//There were errors coded in the response
					var errorToSend = {
						...
						statusCode: 400,
						description: 'Faulty HotelList request made to Atlas. See stack trace for details',
